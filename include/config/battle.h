...
#define B_SMART_WILD_AI_FLAG        0x265 // If not 0, you can set this flag in a script to enable smart wild pokemon
...
#define B_FLAG_AI_VS_AI_BATTLE      0x266 // If this flag is set, the player's mons will be controlled by the ai next battles.
